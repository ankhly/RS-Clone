      ...
      <div class="fooret__container container">
        <div class="footer-content">
          <div class="img-githubs">
            <a class="footer-link" href="https://github.com/ankhly">
              <img class="img-github" src=${github} alt="github1">
            </a>
            <a class="footer-link" href="https://github.com/VolhaYu">
              <img class="img-github" src=${github} alt="github2">
            </a>
            <a class="footer-link" href="https://github.com/MaksimkaSota">
          ...
          <a class="footer-link" href="https://rs.school/js/">
